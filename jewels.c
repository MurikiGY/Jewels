...
//Retorna um se foi marcado um ponto
int candy_drop(){
  ...
  if ( candy_fall_done ){
    ...
    if ( l_candy_fall == -1 ){  //Se matchpoint horizontal
      ...
      if ( board[i_candy_fall-1][j_candy_fall].y == board[l_candy_fall-1][j_candy_fall].y ){  //Se desceu tudo
